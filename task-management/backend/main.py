...
app = FastAPI(title='Backstract Generated APIs - coll-15092a3452b3477d992c28455a8067c2', debug=False,
              docs_url='/adoring-leakey-ca72c8400a1811f092110242ac12000541/docs',
              openapi_url='/adoring-leakey-ca72c8400a1811f092110242ac12000541/openapi.json')
...
app.include_router(
    router,
    prefix='/adoring-leakey-ca72c8400a1811f092110242ac12000541/api',
    tags=['APIs v1']
)
